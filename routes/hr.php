...
Route::middleware(['auth', 'throttle:api-writes'])->prefix('hr')->name('hr.')->group(function () {
    ...
    Route::patch('payroll/settings', [PayrollSettingController::class, 'update'])->name('payroll.settings.update');
    Route::get('payroll/settings/logo', [PayrollSettingController::class, 'logo'])->name('payroll.settings.logo');
    Route::post('payroll/settings/logo', [PayrollSettingController::class, 'uploadLogo'])->name('payroll.settings.logo.upload');
    Route::delete('payroll/settings/logo', [PayrollSettingController::class, 'deleteLogo'])->name('payroll.settings.logo.delete');
