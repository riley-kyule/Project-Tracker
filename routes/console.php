...
Schedule::command('ewms:sync-analytics --days=3')->dailyAt('05:15')->withoutOverlapping(180)->onOneServer();
Schedule::command('ewms:warm-analytics-cache')->dailyAt('06:30')->withoutOverlapping(60)->onOneServer();
