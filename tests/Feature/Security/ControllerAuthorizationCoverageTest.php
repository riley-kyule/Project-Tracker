...
class ControllerAuthorizationCoverageTest extends TestCase
{
    ...
    private const EXEMPT = [
        ...
        'mcp.oauth.token' => 'called by the connecting client\'s own backend, not a browser session — authenticated by client_id/client_secret (McpOAuthClient::verifySecret()) and PKCE code_verifier, if used, plus the single-use authorization code being tied to both that client and the user who approved it in McpOAuthController::approve()',
    ];
