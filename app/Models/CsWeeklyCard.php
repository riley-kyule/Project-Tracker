...
/**
 * One employee's Customer Service weekly card for one work week (Customer
 * Service Board Requirements Specification v1.0 §6). The HOD must approve
 * the plan (plan_approved_at) before the week begins; items are then locked
 * to in-period adjustments that require a reason, per §9 workflow rule 2.
 * Mirrors SeoWeeklyCard.
 */
class CsWeeklyCard extends Model
{
