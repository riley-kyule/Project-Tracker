...
class DepartmentDailySummaryMail extends Mailable
{
    ...
    /**
     * @param  Collection<string, Collection<int, array{label: string, url: string, description: ?string, checklist_progress: ?string}>>  $breakdown  assignee name => tasks they completed today
     ...
     * @param  Collection<string, Collection<int, array{label: string, url: string, description: ?string, checklist_progress: ?string}>>  $reopenedToday  assignee name => tasks reopened today
